...
<template>
  <div class="slogan">
    <h3><span class="prefix">Logoly</span> <span class="postfix">Pro</span></h3>
    <p>
    ...
    <h3 class="miniprogram">Wechat MiniProgram</h3>
    <p style="color: #999">scan to experience</p>
    <img class="miniprogram-qrcode" src="../assets/logoly.pro.png" alt="MiniProgram qrcode">
  </div>
</template>
